...
let CategoryItem = (props: Props) => {
  ...
  // data contains redux results + title prop that is passed into CategoryItem from NavDropDown
  const { title } = props;
  return (
    <Link
...
// connects our redux global state to NavContent and CategoryItem components
